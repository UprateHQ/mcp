...
| Environment | Uprate Backend | MCP Server |
|-------------|---------------|------------|
| Production | `https://app.upratehq.com` | `https://mcp.upratehq.com` |
| Development | `https://dev-app.upratehq.com` | `https://dev-mcp.upratehq.com` |
